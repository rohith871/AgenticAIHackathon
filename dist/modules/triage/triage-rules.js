 ...
 */
export function detectRedFlags(symptomText) {
 ...
 */
export function calculateSeverityScore(detectedFlags) {
...
export function getUrgencyLevel(score) {
    if (score >= SEVERITY_THRESHOLDS.emergency)
        return 'emergency';
...
//# sourceMappingURL=triage-rules.js.map